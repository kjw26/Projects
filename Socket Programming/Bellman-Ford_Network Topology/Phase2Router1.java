...
public class Phase2Router1 {
	...
	static int[][] BF(int[][] arr){
		...
		for(int i=0; i<4; i++){
			minarr[0] = arr1[1][0] + arr1[0][i];
			minarr[1] = arr1[1][1] + arr1[1][i];
			minarr[2] = arr1[1][2] + arr1[2][i];
			minarr[3] = arr1[1][3] + arr1[3][i];
